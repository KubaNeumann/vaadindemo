...
public class VaadinApp extends UI {
	...
	private class MyFormWindow extends Window {
		...
		public MyFormWindow(Action act) {
			...
			cancelBtn.addClickListener((ClickListener) event -> {
                binder.discard();
                close();
            });
		}
	...
	protected void init(VaadinRequest request) {
		...
		addPersonFormBtn.addClickListener((ClickListener) event -> addWindow(new MyFormWindow(Action.ADD)));

		editPersonFormBtn.addClickListener((ClickListener) event -> addWindow(new MyFormWindow(Action.EDIT)));

		deletePersonFormBtn.addClickListener((ClickListener) event -> {
		...
		personsTable.addValueChangeListener((Property.ValueChangeListener) event -> {
